...
#define PLUGIN_VERSION "1.1.5-20140226"
...
public Action:Command_Scan( iClient, nArgs )
{
	...
	for( new iEntity, String:szClassname[21], i = 0; i < 48; i++ )
	{
		...
		if( IsValidEdict( iEntity ) )
		{
			...
			PrintToConsole( iClient, ">>>> m_hMyWeapons (%03d): %05d %s", i, iEntity, szClassname );
			PrintToServer( ">>>> m_hMyWeapons (%03d): %05d %s", i, iEntity, szClassname );
		}
	}
