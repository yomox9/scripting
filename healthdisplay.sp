...
stock AskToDisableMenu(client){
	...
	switch(GetConVarInt(g_cvar_hud)){
		...
		case 0:{
			...
			SetHudTextParams(0.015, 0.08, 5.0, 255, 255, 255, 255, 0, 6.0, 0.1, 0.2);
			if(ShowHudText(client, -1, "Name: Health Display Example (100HP)\nRelationship: Press 1 or 2 please!") == -1){
				PrintHintText(client,"Name: Health Display Example (100HP)\nRelationship: Press 1 or 2");
			}
		}
		case 3:{
			
			PrintCenterText(client,"Name: Health Display Example (100HP)\nRelationship: Press 1 or 2");
		}
		case 2:{
		...
		case 1:{
			...
			SetHudTextParams(0.015, 0.08, 5.0, 255, 255, 255, 255, 0, 6.0, 0.1, 0.2);
			ShowHudText(client, -1, "Name: Health Display Example (100HP)\nRelationship: Press 1 or 2 please!");
		}
	}
				...
				case 2:{
					...
					switch(GetConVarInt(g_cvar_hud)){
						...
						case 0:{
							...
							SetHudTextParams(0.015, 0.08, 5.0, 255, 255, 255, 255, 0, 6.0, 0.1, 0.2);
							if(ShowHudText(client, -1, "Health Display Disabled!") == -1){
	...
	if(success){
		...
		switch(GetConVarInt(g_cvar_hud)){
			...
			case 0:{
				...
				if(ShowHudText(client, -1, "%s (%s)\nRelationship: %s",targetname,health,relationship) == -1){
