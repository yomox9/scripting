...
{
	name = "[NMRiH]Item Shop V3 customized",
	author = "ys24ys",
...
public Action:ClientFunction_PrintRank(Handle:timer, any:Client)
{
	...
	CPrintToChatAll("[\x04Item Shop\x01] %t", "Welcome message", name, ClientCash[Client], TotalPlayers, Cash_Rank[Client]);
}
...
public Shop_Menu_Respawn(Client)
{
	...
	Format(Line3, 128, "Respawn other players - %dc", Price);
	SetMenuTitle(menu, TitleFormat);
	SetMenuExitButton(menu, true);
