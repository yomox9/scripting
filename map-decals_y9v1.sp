...
#define ADMIN_LEVEL_SAVE	ADMFLAG_ROOTz
...
public OnPluginStart() {
	...
	// Commands
	RegConsoleCmd("sm_paintdecal",	Command_PaintDecal,	"Sprays a Decal by <name | id> (names specified in config)");
	RegConsoleCmd("sm_removedecal",	Command_RemoveDecal,"Removes a Decal whilst aiming at it, [all] removes all Decals (on current Map), [id] removes a Decal by id, [last] removes last painted Decal, [name] removes all Decals by decalname (on current Map)");
	RegConsoleCmd("sm_listdecal",	Command_ListDecal, 	"Shows the name of a Decal whilst aiming at it, [all] lists all Decal names available, [id] lists a Decal by id, [last] lists the last painted Decal (on current Map), [map] lists all Decals painted (on current Map), [name] lists all Decals by that Name painted (on current Map), [saved] lists all Decals saved in config File");
	RegConsoleCmd("sm_savedecal",	Command_SaveDecal, 	"Saves a Decal to the config whilst aiming at it, [all] saves all Decals (on current Map), [id] saves a Decal by id, [last] saves last painted Decal, [name] saves all Decals by decalname (on current Map)");
	RegConsoleCmd("sm_aimpos",		Command_GetAimPos, 	"Shows the position you are currently aiming at");
	RegConsoleCmd("sm_decalmenu",	Command_DecalMenu,	"Shows the Map Decals Menu");
