...
public Plugin:myinfo = {
	name = "[NMRiH] Full Infinite Ammo. add JAE-700.fix mac10.NoChainsaw",
...
public OnPluginStart()
{
	...
	nmp_fia_version = CreateConVar( "nmp_fia_version", PLUGIN_VERSION, "NoMorePlugins Full Infinite Ammo Custom_y9v1_NoChainsaw", FCVAR_PLUGIN|FCVAR_NOTIFY|FCVAR_REPLICATED|FCVAR_SPONLY|FCVAR_DONTRECORD );
	...
	BuildPath( Path_SM, szFile, sizeof( szFile ), "data/nmrih_items_data_NoChainsaw.txt" );
