...
static String:Weapon_Tools[TOOLS_MAX][4][64] = {
	...
	{"item_maglite", "Maglite(손전등)", "100", "100"},
...
{
	PrintToChatAll("CashInfo \x01%N\x04 cash \x01%d\x04 rank \x01%d\x04/\x01%d\x04", Client, ClientCash[Client], Cash_Rank[Client], TotalPlayers);
}
