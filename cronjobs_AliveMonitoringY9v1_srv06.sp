...
{
	name = "Cronjobs by yomox9 for AliveMonitoring y9v1 forSrv06",
...
public loadCrons()
{
	if (FileExists("cfg/cronjobs_AM_y9v1_srv06.txt"))
	{
		decl String:fileLine[2700];
		decl String:splited[2024];
		
		new Handle:file = OpenFile("cfg/cronjobs_AM_y9v1_srv06.txt", "rb");
