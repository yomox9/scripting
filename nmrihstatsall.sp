...
public OnPluginStart()
{
	...
	CreateConVar("sm_nmrihstatsall_version", PLUGIN_VERSION, "Simple NMRiH Stats all version", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY|FCVAR_DONTRECORD);
	...
	RegConsoleCmd("sm_ranka", Command_Ranka, "Displays your current rank");
	RegConsoleCmd("sm_top10a", Command_Top10a, "Lists top 10 players");
...
public Action:Command_Ranka(client, args)
{
	ShowRank(client);
...
public Action:Command_Top10a(client, args)
{
	ShowTop10(client);
	return Plugin_Handled;
}
...
public OnClientSayCommand_Post(client, const String:command[], const String:sArgs[])
{
	...
	if(strcmp(text[startidx], "ranka", false) == 0
	|| strcmp(text[startidx], "/ranka", false) == 0
	|| strcmp(text[startidx], "!ranka", false) == 0)
	{
		ShowRank(client);
	}
	else if(strcmp(text[startidx], "top10a", false) == 0
	|| strcmp(text[startidx], "/top10a", false) == 0
	|| strcmp(text[startidx], "!top10a", false) == 0)
	{
		ShowTop10(client);
	}
